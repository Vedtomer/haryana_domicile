...
<head>
    ...
    <title>Password Reset OTP - CSP Jaankari</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 36px 32px;">
                            ...
                            <p style="margin: 0 0 24px; color: #475569; font-size: 14px; line-height: 1.6;">
                                We received a request to reset the password for your <strong>CSP Jaankari</strong> account. Use the 6-digit One-Time Password (OTP) below to complete your password reset:
                            </p>

                            <!-- OTP Box -->
                            <div style="background: #f8fafc; border: 2px dashed #2563eb; border-radius: 12px; padding: 22px; text-align: center; margin: 0 0 24px;">
                                <span style="display: block; font-size: 11px; font-weight: 700; text-transform: uppercase; color: #64748b; letter-spacing: 1.5px; margin-bottom: 8px;">Your 6-Digit Password Reset OTP</span>
                                ...
                                <tr>
                                    <td>
                                        <p style="margin: 0; color: #92400e; font-size: 13px; line-height: 1.5;">
                                            ⏱️ <strong>Note:</strong> This OTP is valid for <strong>10 minutes</strong>. Never share this code with anyone. CSP Jaankari officials will never ask for your password or OTP.
                                        </p>
                                    </td>
                                </tr>
                            </table>
