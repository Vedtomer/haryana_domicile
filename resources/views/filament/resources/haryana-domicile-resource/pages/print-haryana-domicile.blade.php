<x-filament-panels::page>
    <style>
        ...
        .fill-text { border-bottom: 1px dotted #000; font-weight: bold; color: #000; padding: 0 4px; font-family: 'Typist', sans-serif; font-size: 1.1em; } 
        ...
        @media print {
            ...
            .a4-page {
                width: 100% !important;
                margin: 0 !important;
                padding: 15mm 20mm !important; /* Keep internal padding */
                box-shadow: none !important;
                page-break-after: always;
                position: relative !important;
                height: 297mm; /* Force A4 height */
                overflow: hidden; /* Prevent overflow creating new pages */
            }
            .a4-page:last-child {
                page-break-after: auto; /* No break after last page */
            }
            .fi-sidebar, .fi-header, .fi-topbar, .print-btn-container {
                display: none !important;
            }
        }
    </style>

    <div class="flex justify-end mb-4 print-btn-container">
        <x-filament::button
