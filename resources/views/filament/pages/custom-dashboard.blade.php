    ...
    <div x-data="{ showPanModal: false, showPhoneToAadharModal: false }" 
        ...
        <div class="service-grid w-full max-w-7xl mx-auto">
            ...
            $other_services = [
                ...
                ['name' => 'PPP FASAL<br>SEARCH', 'icon' => 'fa-search-plus', 'bg' => 'bg-purple-100 border-purple-200 hover:bg-purple-200', 'icon_color' => 'text-purple-700', 'url' => \App\Filament\Pages\FasalSearch::getUrl(), 'permission' => 'page_FasalSearch'],
                ['name' => 'Aadhar No. to<br>Famliy Data', 'icon' => 'fa-users-viewfinder', 'bg' => 'bg-sky-100 border-sky-200 hover:bg-sky-200', 'icon_color' => 'text-sky-700', 'url' => \App\Filament\Pages\FamilyDataSearch::getUrl(), 'permission' => 'page_FamilyDataSearch'],
                ['name' => 'Pan To Aadhaar<br>Link Status', 'icon' => 'fa-link', 'bg' => 'bg-indigo-100 border-indigo-200 hover:bg-indigo-200', 'icon_color' => 'text-indigo-700', 'url' => 'https://eportal.incometax.gov.in/iec/foservices/#/pre-login/link-aadhaar-status', 'external' => true],
                ['name' => 'RESIZE<br>PDF', 'icon' => 'fa-file-pdf', 'bg' => 'bg-slate-100 border-slate-300 hover:bg-slate-200', 'icon_color' => 'text-slate-700', 'url' => 'https://pdf.pi7.org/resize-pdf', 'external' => true],
                ['name' => 'Pention<br>Check', 'icon' => 'fa-hand-holding-heart', 'bg' => 'bg-fuchsia-100 border-fuchsia-200 hover:bg-fuchsia-200', 'icon_color' => 'text-fuchsia-700', 'url' => 'https://pension.socialjusticehry.gov.in/Ben_Inf', 'external' => true],
                ['name' => 'LIC<br>PAY', 'icon' => 'fa-shield-heart', 'bg' => 'bg-blue-100 border-blue-300 hover:bg-blue-200', 'icon_color' => 'text-blue-800', 'url' => 'https://ebiz.licindia.in/D2CPM/#DirectPay', 'external' => true],
                ['name' => 'Photo Bg<br>Remove', 'icon' => 'fa-image-portrait', 'bg' => 'bg-violet-100 border-violet-200 hover:bg-violet-200', 'icon_color' => 'text-violet-700', 'url' => 'https://www.remove.bg/', 'external' => true],
                ['name' => 'Phone to<br>Aadhar', 'icon' => 'fa-mobile-retro', 'bg' => 'bg-pink-100 border-pink-200 hover:bg-pink-200', 'icon_color' => 'text-pink-700', 'url' => \App\Filament\Pages\PhoneToAadhar::getUrl(), 'count' => $counts['service_requests'] ?? 0, 'permission' => 'page_PhoneToAadhar'],
                ['name' => 'Phone to<br>Detail', 'icon' => 'fa-id-card-clip', 'bg' => 'bg-cyan-100 border-cyan-200 hover:bg-cyan-200', 'icon_color' => 'text-cyan-700', 'url' => \App\Filament\Pages\PhoneToDetail::getUrl(), 'permission' => 'page_PhoneToDetail'],
                ['name' => 'Vehicle<br>Detail', 'icon' => 'fa-truck-fast', 'bg' => 'bg-lime-100 border-lime-200 hover:bg-lime-200', 'icon_color' => 'text-lime-700', 'url' => \App\Filament\Pages\VehicleDetail::getUrl(), 'permission' => 'page_VehicleDetail'],
                ['name' => 'Aadhaar<br>Info', 'icon' => 'fa-id-card', 'bg' => 'bg-amber-100 border-amber-200 hover:bg-amber-200', 'icon_color' => 'text-amber-700', 'url' => \App\Filament\Pages\ManualService::getUrl(['type' => 'aadhar']), 'permission' => 'page_ManualService'],
                ['name' => 'Family<br>Info', 'icon' => 'fa-users-between-lines', 'bg' => 'bg-emerald-100 border-emerald-300 hover:bg-emerald-200', 'icon_color' => 'text-emerald-800', 'url' => \App\Filament\Pages\ManualService::getUrl(['type' => 'familyinfo']), 'permission' => 'page_ManualService'],
                ['name' => 'Linked<br>Mobile', 'icon' => 'fa-link-slash', 'bg' => 'bg-sky-100 border-sky-300 hover:bg-sky-200', 'icon_color' => 'text-sky-800', 'url' => \App\Filament\Pages\ManualService::getUrl(['type' => 'vnum']), 'permission' => 'page_ManualService'],
                ['name' => 'Instagram<br>Intel', 'icon' => 'fa-brands fa-instagram', 'bg' => 'bg-pink-100 border-pink-300 hover:bg-pink-200', 'icon_color' => 'text-pink-800', 'url' => \App\Filament\Pages\ManualService::getUrl(['type' => 'insta']), 'permission' => 'page_ManualService'],
                ['name' => 'Pincode<br>Details', 'icon' => 'fa-map-location-dot', 'bg' => 'bg-green-100 border-green-300 hover:bg-green-200', 'icon_color' => 'text-green-800', 'url' => \App\Filament\Pages\ManualService::getUrl(['type' => 'pincode']), 'permission' => 'page_ManualService'],
                ['name' => 'PAN<br>Info', 'icon' => 'fa-id-card', 'bg' => 'bg-orange-100 border-orange-300 hover:bg-orange-200', 'icon_color' => 'text-orange-800', 'url' => \App\Filament\Pages\ManualService::getUrl(['type' => 'pan']), 'permission' => 'page_ManualService'],
                ['name' => 'Telegram<br>Number', 'icon' => 'fa-brands fa-telegram', 'bg' => 'bg-sky-200 border-sky-400 hover:bg-sky-300', 'icon_color' => 'text-sky-800', 'url' => \App\Filament\Pages\ManualService::getUrl(['type' => 'tgnum']), 'permission' => 'page_ManualService'],
                ['name' => 'Vehicle<br>Owner', 'icon' => 'fa-user-tag', 'bg' => 'bg-teal-100 border-teal-300 hover:bg-teal-200', 'icon_color' => 'text-teal-800', 'url' => \App\Filament\Pages\ManualService::getUrl(['type' => 'vowner']), 'permission' => 'page_ManualService'],
                ['name' => 'IFSC<br>Details', 'icon' => 'fa-building-columns', 'bg' => 'bg-indigo-100 border-indigo-300 hover:bg-indigo-200', 'icon_color' => 'text-indigo-800', 'url' => \App\Filament\Pages\ManualService::getUrl(['type' => 'ifsc']), 'permission' => 'page_ManualService'],
                ['name' => 'GST<br>Data', 'icon' => 'fa-briefcase', 'bg' => 'bg-violet-100 border-violet-300 hover:bg-violet-200', 'icon_color' => 'text-violet-800', 'url' => \App\Filament\Pages\ManualService::getUrl(['type' => 'gst']), 'permission' => 'page_ManualService'],

                ['name' => 'MY REQUESTS<br>& REPLIES', 'icon' => 'fa-bell', 'bg' => 'bg-orange-100 border-orange-300 hover:bg-orange-200 shadow-md shadow-orange-500/10', 'icon_color' => 'text-orange-700', 'url' => '/service-requests', 'count' => $counts['service_requests'] ?? 0, 'permission' => 'view_any_service::request'],
            ];
