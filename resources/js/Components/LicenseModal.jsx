                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-in fade-in duration-150">
                    <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full overflow-hidden">
                        ...
                        <div className="flex border-b border-gray-100 bg-gray-50/70 p-1">
                            ...
                            >
                                {hasActiveLicense ? '🔄 Renew (+6M)' : '⚡ Direct (50 Coins)'}
                            </button>
                            <button
                                type="button"
                                onClick={() => setTab('key')}
                        ...
                        <div className="p-5 sm:p-6">
                            {/* Tab 1: Direct Activate / Renew */}
                            {tab === 'direct' && (
                                <div className="text-center space-y-4">
                                    <p className="text-sm text-gray-600 font-medium leading-relaxed">
                                        {hasActiveLicense ? (
                                            <>
                                                Aapke wallet se <strong>50 Coins</strong> deduct honge aur aapki validity me <strong>+6 mahine (180 din)</strong> aur add ho jayenge.
                                            </>
                                        ) : (
                                            <>
                                    ...
                                    {userCoins >= 50 ? (
                                        ...
                                        >
                                            <span className="material-symbols-outlined text-[18px]">
                                                {hasActiveLicense ? 'autorenew' : 'bolt'}
                                            </span>
                                            {isActivating
                                                ? 'Processing...'
                                                : hasActiveLicense
                                                    ? 'Renew for 6 Months (50 Coins)'
                                                    : 'Activate 6-Month License (50 Coins)'}
                                        </button>
                                    ) : (
