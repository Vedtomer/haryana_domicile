    ...
    const services = [
        {
            ...
            description: 'Download your e-Aadhaar card using Aadhaar Number, Enrolment ID, or Virtual ID.',
            icon: 'download',
        ...
        },
        {
            ...
            description: 'Check if your Aadhaar is generated or updated.',
            icon: 'fact_check',
        ...
        },
        {
            ...
            description: 'Update your demographic details online (Name, DOB, Gender, Address).',
            icon: 'edit_document',
        ...
        },
        {
            ...
            description: 'Verify the authenticity of an Aadhaar Number.',
            icon: 'verified_user',
            url: 'https://myaadhaar.uidai.gov.in/verifyAadhaar',
            color: 'purple'
        },
        {
            title: 'Retrieve EID / Aadhaar',
            description: 'Find out your lost Enrolment ID (EID) or Aadhaar Number (UID).',
            icon: 'find_in_page',
        ...
        },
        {
            ...
            description: 'Secure your biometric authentication by locking them temporarily.',
            icon: 'lock',
            url: 'https://myaadhaar.uidai.gov.in/',
            color: 'red'
        }
            ...
            header={
                <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500 dark:text-slate-400 mt-0.5">
                        Official UIDAI portals for Aadhaar related utilities
                    </p>
                </div>
            }
        >
                    ...
                    {services.map((service, index) => (
                        ...
                        >
                            ...
                            <div className="mt-6 flex items-center text-sm font-bold text-blue-600 dark:text-blue-400">
                                Open Securely
                                <span className="material-symbols-outlined ml-1 text-sm group-hover:translate-x-1 transition-transform">open_in_new</span>
                            </div>
                        </a>
                    ))}
                </div>
