                        ...
                        <form onSubmit={handleSearch} className="space-y-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 rounded-xl focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none text-xl tracking-[0.1em] font-black transition-all text-center dark:text-white"
                                />
                            </div>
