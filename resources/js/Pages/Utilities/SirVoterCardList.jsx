            ...
            header={
                <div className="flex flex-col">
                    ...
                    <p className="text-sm text-gray-500 dark:text-slate-400 mt-0.5">
                        Search and download voter list details and electoral roll by EPIC number or area
                    </p>
                </div>
            }
        >
                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-800 overflow-hidden mb-8">
                    <div className="p-8">
                        <div className="max-w-2xl mx-auto text-center">
                            <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/30 dark:to-indigo-900/30 text-purple-600 dark:text-purple-400 rounded-2xl mb-5 mx-auto shadow-inner">
                            ...
                            <p className="text-slate-500 dark:text-slate-400 mb-6 font-medium text-sm">
                                Find voter card serial number, polling station, and booth details instantly.
                            </p>
                            ...
                            <form onSubmit={handleSearch} className="space-y-4 text-left">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                placeholder="e.g. Karnal, Panipat, Gurugram"
                                                className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border-2 border-slate-200 dark:border-slate-700 rounded-xl font-bold dark:text-white text-sm"
                                            />
                                        </div>
                                        <div>
                                            <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase mb-1">Assembly (AC Name / No)</label>
                                            <input
                                                type="text"
                                                value={acName}
                                        ...
                                        <div>
                                            <label className="block text-xs font-bold text-slate-700 dark:text-slate-300 uppercase mb-1">Voter Name (Optional)</label>
                                            <input
                                                type="text"
                                                value={voterName}
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full py-4 px-6 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-black text-base rounded-2xl shadow-lg shadow-purple-600/30 transition-all disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer mt-2"
                                >
                                    {loading ? (
                                        <>
                ...
                {result && (
                    <div className="space-y-6 mb-12 animate-fade-in-up">
                        <div className="bg-gradient-to-r from-purple-600 to-indigo-700 rounded-3xl p-6 text-white shadow-xl flex flex-col sm:flex-row items-center justify-between gap-4">
                            <div>
                                <span className="text-xs font-bold uppercase tracking-widest text-purple-200">Election Commission Electoral Roll</span>
