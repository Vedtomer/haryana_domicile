...
export default function PanFullDetails() {
    ...
    const handleSearch = async (e) => {
        ...
        setResult(null);
        try {
            const response = await axios.post('/utilities/pan-full-details-instant/search', { pan: clean });
    ...
    return (
        ...
        >
            <Head title="PAN Full Details Instant" />
                ...
                {result && (
                    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-800 overflow-hidden animate-in fade-in zoom-in duration-300">
                        ...
                        <div className="p-6 space-y-1">
                            ...
                            <InfoRow label="Father's Name"       value={result.father_name || result.fathers_name || result.Fathers_name}  icon="family_restroom" />
