...
export default function PvcCardMaker({ cards, defaultCard, userCoins, isAdmin, isConfigured }) {
    ...
    return (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                            <span className="material-symbols-outlined text-indigo-600 dark:text-indigo-400">badge</span>
                            Smart PVC Card Maker
                        </h1>
                        <p className="text-sm text-gray-500 dark:text-slate-400 mt-0.5">
                            Auto-convert Haryana Family ID, Aadhaar, Ayushman, Voter, PAN PDFs into Print-Ready PVC Cards & A4 Print Sheets
                        </p>
                    </div>
        ...
        >
            ...
            <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 space-y-6">
                ...
                {/* Configuration Warning if API key is not set */}
                {!isConfigured && (
                    <div className="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/50 rounded-2xl flex items-start gap-3.5 text-amber-900 dark:text-amber-200">
                        ...
                        <div className="text-sm">
                            <p className="font-bold">IDCard.Store API Key Required</p>
                            <p className="text-xs text-amber-700 dark:text-amber-300 mt-0.5">
                                Please configure <code className="bg-amber-100 dark:bg-amber-800/40 px-1.5 py-0.5 rounded font-mono">IDCARD_STORE_API_KEY</code> in your <code className="font-mono">.env</code> file. Cards will process once your key is added and wallet has balance.
                            </p>
                        </div>
                    </div>
                )}
                            ...
                            >
                                {loading ? (
                                    <>
                                        ...
                                        <span>Generating PVC Card...</span>
                                    </>
                                ) : (
                                    <>
                                        <span className="material-symbols-outlined text-lg">auto_fix_high</span>
                                        <span>Generate PVC Card Now</span>
                                    </>
                                )}
                            </button>
                        </form>
