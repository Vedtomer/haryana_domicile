...
export default function Login() {
    ...
    return (
        <div className="min-h-screen relative flex items-center justify-center p-4 bg-slate-900 overflow-hidden font-sans selection:bg-blue-500 selection:text-white">
            ...
            <div className={`relative z-10 w-full max-w-lg transition-all duration-1000 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                ...
                <div className="absolute -top-12 left-0">
                    <Link href="/" className="flex items-center text-slate-300 hover:text-white transition-colors group">
