...
class ServiceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $services = [
            ...
            [
                'name' => 'Mobile to Details',
                'slug' => 'telegram-num',
                'description' => 'Instantly retrieve owner details from mobile number.',
                'icon' => '📱',
                'coin_cost' => 10,
                'kind' => Service::KIND_MODULE,
                'module_key' => 'telegram_num',
                'sort_order' => 7,
                'is_active' => true,
                'visibility' => Service::VISIBILITY_PRIVATE,
            ],
            [
                'name' => 'Aadhar Details',
                'slug' => 'telegram-aadhar',
                'description' => 'Instantly retrieve Aadhar details.',
                'icon' => '🪪',
                'coin_cost' => 10,
                'kind' => Service::KIND_MODULE,
                'module_key' => 'telegram_aadhar',
                'sort_order' => 8,
                'is_active' => true,
                'visibility' => Service::VISIBILITY_PRIVATE,
            ],
            [
                'name' => 'Family Info (PPP)',
                'slug' => 'telegram-familyinfo',
                'description' => 'Instantly retrieve details associated with a Family ID.',
                'icon' => '👨‍👩‍👧‍👦',
                'coin_cost' => 10,
                'kind' => Service::KIND_MODULE,
                'module_key' => 'telegram_familyinfo',
                'sort_order' => 9,
                'is_active' => true,
                'visibility' => Service::VISIBILITY_PRIVATE,
            ],
            [
                ...
                'slug' => 'telegram-pan',
                'description' => 'Instantly retrieve details associated with a PAN Card.',
                'icon' => '💳',
                'coin_cost' => 10,
                'kind' => Service::KIND_MODULE,
                'module_key' => 'telegram_pan',
                'sort_order' => 10,
                'is_active' => true,
                'visibility' => Service::VISIBILITY_PRIVATE,
            ],
            [
                'name' => 'Ration Card Details',
                'slug' => 'telegram-ration',
                'description' => 'Fetch Ration Card holder details.',
                'icon' => '📄',
                'coin_cost' => 10,
                'kind' => Service::KIND_MODULE,
                'module_key' => 'telegram_ration',
                'sort_order' => 11,
                'is_active' => true,
                'visibility' => Service::VISIBILITY_PRIVATE,
            ],
